...
public class grafikController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        colDetailNombre.setCellValueFactory(
                (TableColumn.CellDataFeatures<modelGrafik, String> cellData) ->
                        cellData.getValue().nombredenomsProperty().asString());
        colDetailAnnee.setCellValueFactory(
                (TableColumn.CellDataFeatures<modelGrafik, String> cellData) ->
                        cellData.getValue().anneeProperty());
    ...
    private void affichage(){
        dataDetail = crudGrafik.getAnneDeNaissance();
