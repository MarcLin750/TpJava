...
public class biodataController implements Initializable {
     ...
     * @param Ressopurce Bundle
     */
    public void initialize(URL url, ResourceBundle rb) {
        colId.setCellValueFactory(
                (TableColumn.CellDataFeatures<modelBiodata, String> cellData) ->
                        cellData.getValue().idProperty());
        colNom.setCellValueFactory((TableColumn.CellDataFeatures<modelBiodata, String> cellData) ->
                        cellData.getValue().nomProperty());
        colAdresse.setCellValueFactory((TableColumn.CellDataFeatures<modelBiodata, String> cellData) ->
    ...
    @FXML
    /**
     * méthode de hgestion d'évènement clic
     */
